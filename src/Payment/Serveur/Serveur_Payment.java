 ...
 * @author student
 */
public class Serveur_Payment extends javax.swing.JFrame implements ConsoleServeurPayment
{
    private int portBillets;
    private ThreadServeurPayment ts;
    private static final int NbClient = 10;
    /**
     * Creates new form Serveur_Payment
     */
    ...
    private void StartBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StartBTActionPerformed
        ...
        ts = new ThreadServeurPayment(portBillets, new ListeTachesPayment(), this, NbClient);
        ts.start();
