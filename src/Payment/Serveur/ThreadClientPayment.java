 ...
 * @author student
 */
public class ThreadClientPayment extends Thread
{
    private SourceTaches tachesAExecuter;
    private String nom;
    private ConsoleServeurPayment cs;
    private Socket tacheEnCours;
    
    public ThreadClientPayment(SourceTaches st, String n, ConsoleServeurPayment cs)
    {
        ...
        while (!isInterrupted())
        {
            ...
            while(log == true)
            {
                try {
                    ...
                    Logger.getLogger(ThreadClientPayment.class.getName()).log(Level.SEVERE, null, ex);
                }
