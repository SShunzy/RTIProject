 ...
 */
package GUI;
import GUI.SelectFrame.SelectAgentJFrame;
 ...
 * @author student
 */
public class AgentsJFrame extends javax.swing.JFrame {
    ...
    public AgentsJFrame() throws ClassNotFoundException, SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nombre d'agents :");
    ...
    private void SELECTBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SELECTBTActionPerformed
        // TODO add your handling code here:
        SelectAgentJFrame SAF = new SelectAgentJFrame(AB,this,false);
        SAF.show();
    ...
    private void UPDATEBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UPDATEBTActionPerformed
        ...
        String Nom = (String)Tableau.getValueAt(Tableau.getSelectedRow(), 1);
        String Prenom = (String)Tableau.getValueAt(Tableau.getSelectedRow(), 2);
        String Poste = (String)Tableau.getValueAt(Tableau.getSelectedRow(), 3);
        
        try {
            AB.Update(Id, "","","",0,Nom,Prenom,Poste);
    ...
    private void INSERTBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_INSERTBTActionPerformed
        // TODO add your handling code here:
        SelectAgentJFrame SAF = new SelectAgentJFrame(AB,this,true);
        SAF.show();
    ...
    private void DELETEBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DELETEBTActionPerformed
        ...
        try{
            ResultSet rs = AB.Select(false, Id, "","","");
            while(rs.next())
                rs.deleteRow();
            this.RefreshTable();
        } catch (SQLException ex) {
