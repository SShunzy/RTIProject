 ...
 */
package GUI;
import GUI.SelectFrame.SelectBaggageJFrame;
 ...
 * @author student
 */
public class BaggagesJFrame extends javax.swing.JFrame {
    ...
    public BaggagesJFrame() throws ClassNotFoundException, SQLException {
        initComponents();
        this.setTitle("Baggages");
        int cpt = 0;
        BB = new BaggagesBean();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nombre de baggages :");
    ...
    private void SELECTBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SELECTBTActionPerformed
        // TODO add your handling code here:
        SelectBaggageJFrame SBF = new SelectBaggageJFrame(BB,this,false);
        SBF.show();
    ...
    private void UPDATEBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UPDATEBTActionPerformed
        ...
        String Billet = (String)Tableau.getValueAt(Tableau.getSelectedRow(), 1);
        
        try {
            BB.Update(Id, "",0,Billet);
    ...
    private void INSERTBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_INSERTBTActionPerformed
        // TODO add your handling code here:
        SelectBaggageJFrame SBF = new SelectBaggageJFrame(BB,this,true);
        SBF.show();
    ...
    private void DELETEBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DELETEBTActionPerformed
        ...
        try{
            ResultSet rs = BB.Select(false, Id, "");
            while(rs.next())
                rs.deleteRow();
            this.RefreshTable();
        } catch (SQLException ex) {
