 ...
 * @author student
 */
public class ServeurXML extends javax.swing.JFrame implements ConsoleServeurXMLPP
{
    ...
    private void StartBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StartBTActionPerformed
        ...
        ts = new ThreadServeurXML(PORT_TOWER, new ListeTachesXML(), this);
        ts.start();
    ...
    public static void main(String args[]) 
    {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServeurXML.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServeurXML().setVisible(true);
            }
        });
    }
