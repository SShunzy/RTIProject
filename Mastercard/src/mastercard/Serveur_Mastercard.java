 ...
 * @author student
 */
public class Serveur_Mastercard extends javax.swing.JFrame implements ConsoleServeurMastercard
{
    private static int NBCLIENTS = 20;
    
    private int PORT_SECURE_BANK;
    private ThreadServeurMastercard ts;
    /**
    ...
    private void StartBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StartBTActionPerformed
        PORT_SECURE_BANK = Integer.parseInt(PortTF.getText());
        TraceEvenements("serveur#acquisition du port#main");
        ts = new ThreadServeurMastercard(PORT_SECURE_BANK, new ListeTacheMastercard(), this, NBCLIENTS);
        ts.start();
    ...
    public boolean isLoadedEnough(String numéro, String nom, double prix) {
        ...
        System.out.println("Vérification du solde de la carte "+numéro+ " appartenant à "+nom);
    ...
    public int doPayment(String numéro, String nom, double prix){
        //Effectue le paiement et envoie une notification au client sous forme de mail
        
        System.out.println("Débit de "+prix+" sur le compte de "+nom);
